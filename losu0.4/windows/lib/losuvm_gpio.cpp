...
extern "C"
{
    const char* ls_gpio_export(const char* gpio)
    {
        ofstream _f;
    ...
    const char* ls_gpio_unexport(const char* gpio)
    {
        ofstream _f;
    ...
    const char* ls_gpio_model(const char* gpio,const char* model)
    {
        //model 0 == in ; 1 == out
        ofstream _f;
        string _gpio_file;
    ...
    const char* ls_gpio_value(const char* gpio,const char* model)
    {
        //model 0 == low ; 1 == high
        ofstream _f;
        string _gpio_file;
    ...
    const char* ls_gpio_read(const char* gpio)
    {
        int val;
        ifstream _f;
        string _gpio_file;
