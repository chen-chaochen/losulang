...
wget https://gitee.com/chen-chaochen/lpk/raw/release/losu0.2/linux/lib/losuvm_httpd.cpp
...
g++ -shared -fPIC -o losuvm_httpd.lsd losuvm_httpd.cpp
...
wget https://gitee.com/chen-chaochen/lpk/raw/release/losu0.2/linux/inc/服务器.losu
losuc MD5
losuc MD转换器
losuc 标准流
losuc 时间
